							...
							<div class="col-sm-12">
								<div class="row">
									...
									<div class="col-sm-9">
										...
										<div class="row">
											<div class="col-sm-4"
												style="margin-left: 10px; margin-top: 1%; font-size: 12px;">${loginUser.email }</div>
										</div>
									</div>
								</div>
							</div>
						</div>
						<div class="row" style="position: relative; height: 180px; margin-top: 5px;">
							<div class="col-sm-12"
								style="position: absolute; margin-left: auto; bottom: 0; border: 1px solid #E4E8EB; margin-top: 10px; height: 9vw;">
								<div
									style="position: absolute; top: 0; width: 100%; height: 20%; left: 0;"
								...
								<div
									style="background-color: #ebebeb; position: absolute; bottom: 0; height: 80%; width: 100%; left: 0;">
									<div class="main">
										<div class="card">
											<div class="board">
												<c:forEach var="i" begin="1" end="4">
													<a class="list" href="#"> <time>${i } 분 전</time>
														<p>test${i }</p>
														<hr>
													</a>
												</c:forEach>
