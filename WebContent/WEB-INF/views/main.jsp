		...
		<div class="container-fluid">
			<div class="icon" title="Home Page">
				<div class="icon" onclick="goToMainPage()"
					style="background-image: url(resources/img/icon.png);"></div>
			</div>
						...
						<div id="carouselExampleIndicators" class="carousel slide"
							...
							<div class="carousel-inner">
								<div class="carousel-item active">
									<div class="img"
										style="background-image: url(resources/img/1.jpg)"></div>
								</div>
								<div class="carousel-item">
									<div class="img"
										style="background-image: url(resources/img/2.jpg)"></div>
								</div>
								<div class="carousel-item">
									<div class="img"
										style="background-image: url(resources/img/3.png)"></div>
								</div>
							</div>
